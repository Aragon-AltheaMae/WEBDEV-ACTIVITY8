...
const studentsData = {
    aragon: {
        ...
        address: "83 Sambakai Kalayaan Brgy. 201 Pasay City",
...
function populateProfile(studentKey) {
    ...
    if (!student) {
        console.warn(`Student not found: "${studentKey}". Loading default profile.`);
        return populateProfile("aragon");
    }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    populateProfile(studentParam || "aragon");
});
